## Projects repository 
In the Projects folder you will find subfolders containing coursework projects.

### Reinforcement_learning 
- A project where two agents play tic tac toe against eachother.

### Stochastic_optimization 
- A project aimed att training a MPL with genetic algorithms for optimizing a brake pattern on a simulated truck ride.
